...
namespace PlaceOpenComponent.Buttons
{
	internal abstract class InventorButton
	{
		...
		protected ButtonDefinition Definition
		{
			get
			{
		...
		protected CommandControl _button;
		...
		private IPictureDisp LightThemeLargeIcon => ImageConverter.CreateIcon(GetLargeIconResourceName());
		private IPictureDisp DarkThemeLargeIcon => ImageConverter.CreateIcon(GetDarkThemeLargeIconResourceName());
		private IPictureDisp LightThemeSmallIcon => ImageConverter.CreateIcon(GetSmallIconResourceName());
		private IPictureDisp DarkThemeSmallIcon => ImageConverter.CreateIcon(GetDarkThemeSmallIconResourceName());
