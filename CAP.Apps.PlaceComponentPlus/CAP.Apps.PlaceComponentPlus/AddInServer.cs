            ...
            try
            {
                ...
                if (firstTime)
                {
                    ...
                    if (uiMan.InterfaceStyle == InterfaceStyleEnum.kRibbonInterface)
                    {
                        ...
                        RibbonPanel panel = tab.RibbonPanels["id_PanelA_AssembleComponent"]; //.Add("CAP.Apps.PlaceComponentPlus", AddinGlobal.InternalPanelName.ToString(), AddinGlobal.PanelGUID.ToString());
